...
public:
	ObjectEnemyBlue(int iAppearance, int iOutTime, int iPosX, int iPosY, int iDestPosX, int iDestPosY, float fDestAngle,
		int iOutPosX, int iOutPosY, float fOutAngle);
	virtual ~ObjectEnemyBlue();
