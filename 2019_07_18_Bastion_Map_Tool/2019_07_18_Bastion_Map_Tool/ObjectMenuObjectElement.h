...
class ObjectMenuObjectElement : public ObjectMenuElement
{
public:
	ObjectMenuObjectElement(int iSpriteIndex, int iPosX, int iPosY, int * iScrollTopPtr, int * iScrollBottomPtr);
	virtual ~ObjectMenuObjectElement();
