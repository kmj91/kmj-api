...
class ObjectMenuPlayerElement : public ObjectMenuElement
{
public:
	ObjectMenuPlayerElement(int iSpriteIndex, int iPosX, int iPosY, int * iScrollTopPtr, int * iScrollBottomPtr);
	virtual ~ObjectMenuPlayerElement();
