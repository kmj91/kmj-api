...
public:
	...
	// 특정 메모리 위치에 스프라이트를 출력(칼라키, 클리핑 처리) + 스프라이트 크기 늘려서 출력
	void DrawIncreaseSprite(int iSpriteIndex, int iDrawX, int iDrawY, BYTE *bypDest, int iDestWidth,
		int iDestHeight, int iDestPitch, int iIncreaseValue, bool bCameraOption = true);

	// 스프라이트 특정영역 잘래내고 출력
	void DrawCutOutSprite(int iSpriteIndex, int iDrawX, int iDrawY, BYTE *bypDest, int iDestWidth,
	...
	// 이미지 특정영역 잘래내고 출력 + 스프라이트 크기 늘려서 출력
	void DrawCutOutIncreaseImage(int iSpriteIndex, int iDrawX, int iDrawY, BYTE *bypDest, int iDestWidth,
		int iDestHeight, int iDestPitch, int iIncreaseValue, RECT SpriteCutOutRect, bool bCameraOption = true);
	...
	// 사각형 테두리 그리기
	void DrawRectangleBorder(DWORD dwRGBColor, int iBorderValue, int iDrawX, int iDrawY, int iWidth, int iHeight,
		BYTE *bypDest, int iDestWidth, int iDestHeight, int iDestPitch, bool bCameraOption = false);
